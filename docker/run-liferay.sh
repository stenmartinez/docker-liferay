...
ES_CONFIG_FILE=${LIFERAY_HOME}/osgi/configs/com.liferay.portal.search.elasticsearch6.configuration.ElasticsearchConfiguration.config
DB_PORTAL_FILE=${LIFERAY_HOME}/portal-ext.env.properties
